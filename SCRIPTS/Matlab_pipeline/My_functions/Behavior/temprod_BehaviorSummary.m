function  [med,meAn,SD,meAnnorm] = temprod_BehaviorSummary(subject,RunNum,fsample,TD,savetag)

DataDir             = ['/neurospin/meg/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Trans_sss_' subject];
...
print('-r0','-dpng',['/neurospin/meg/meg_tmp/temprod_Baptiste_2010/DATA/NEW/Plots_' subject '/behavioral.png']);
