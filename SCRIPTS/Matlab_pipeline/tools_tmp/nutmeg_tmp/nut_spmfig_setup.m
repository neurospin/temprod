...
% sttell time series to refresh after clicking around in SPM volume
...
[dum,mrifile]=fileparts(coreg.mripath);
if(isfield(coreg,'norm_mripath') || mrifile(1)=='w' || ~isempty(findstr(coreg.mripath,['templates' filesep 'T1.img'])))
