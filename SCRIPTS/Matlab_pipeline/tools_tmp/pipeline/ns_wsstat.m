function stat=ns_wsstat(tr1,tr2,av1,av2,lat,timepoints)
...
% av1(av2) = grand-averaged dataset for condition 1(2) containing the averages
% only (from ft_timelockgrandaverage)
